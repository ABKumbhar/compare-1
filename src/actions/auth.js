...
export const loadUser = () => (dispatch, getState) => {
  ...
  axios
    .get('https://aniket1999.pythonanywhere.com/en/auth/user', tokenConfig(getState))
    .then((res) => {
      dispatch({
        type: USER_LOADED,
        payload: res.data,
...
export const logout = () => (dispatch, getState) => {
  axios
    .post('https://aniket1999.pythonanywhere.com/en/auth/logout', null, tokenConfig(getState))
    .then((res) => {
